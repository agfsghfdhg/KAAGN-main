...
EMB_PATHS = {
    'transe': '/home/xyNLP/data/kl/DRGN-main/data/transe/glove.transe.sgd.ent.npy',
    'lm': '/home/xyNLP/data/kl/DRGN-main/data/transe/glove.transe.sgd.ent.npy',
    'numberbatch': '/home/xyNLP/data/kl/DRGN-main/data/transe/concept.nb.npy',
    'tzw': '/home/xyNLP/data/kl/DRGN-main/data/cpnet/tzw.ent.npy',
}
...
def add_data_arguments(parser):
    ...
    # 内部训练集
    parser.add_argument('--inhouse_train_qids', default='/home/xyNLP/data/kl/DRGN-main/data/{dataset}/inhouse_split_qids.txt', help='qids of the in-house training set')
    # statements
    parser.add_argument('--train_statements', default='/home/xyNLP/data/kl/DRGN-main/data/{dataset}/statement/train.statement.jsonl')
    parser.add_argument('--dev_statements', default='/home/xyNLP/data/kl/DRGN-main/data/{dataset}/statement/dev.statement.jsonl')
    parser.add_argument('--test_statements', default='/home/xyNLP/data/kl/DRGN-main/data/{dataset}/statement/test.statement.jsonl')
...
def get_parser(): # 处理所有模型共享的参数的辅助函数
